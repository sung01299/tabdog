...
struct HostRegistrationService {
    ...
    static func register(extensionId: String, browsers: [Browser]) throws {
        ...
        let manifest: [String: Any] = [
            "name": hostName,
            "description": "TabDog Native Messaging Host - Bridge Chrome tabs to macOS menu bar",
            "path": appPath,
            "type": "stdio",
            "allowed_origins": [
        ...
        for browser in browsers {
            ...
            print("[TabDog] Host manifest registered for \(browser.displayName) at: \(hostManifestPath(for: browser).path)")
        }
    }
    ...
    static func unregister() throws {
        ...
        print("[TabDog] Host manifests removed")
    }
