...
class SharedDataService {
    ...
    private let sharedDirectory: URL = {
        ...
        return appSupport.appendingPathComponent("TabDog", isDirectory: true)
    }()
    ...
    func writeTabData(_ data: TabsUpdateData, browser: String) {
        do {
            ...
            print("[TabDog] Failed to write tab data for \(browser): \(error)")
        }
    }
    ...
    func readTabData(for browser: String) -> TabsUpdateData? {
        ...
        do {
            ...
            print("[TabDog] Failed to read tab data for \(browser): \(error)")
            return nil
        }
    }
    ...
    func writeCommand(_ command: TabCommand) {
        ...
        do {
            ...
            print("[TabDog] Wrote command \(command.type) for \(browser)")
        } catch {
            print("[TabDog] Failed to write command: \(error)")
        }
    }
