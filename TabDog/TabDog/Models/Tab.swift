...
extension Tab {
    ...
    static let samples: [Tab] = [
        Tab(tabId: 1, windowId: 1, title: "GitHub - TabDog", url: "https://github.com/user/tab-doggy", favIconUrl: nil, active: true, pinned: false, openedAt: Int64(Date().addingTimeInterval(-7200).timeIntervalSince1970 * 1000)),
