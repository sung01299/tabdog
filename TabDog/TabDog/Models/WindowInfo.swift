...
extension WindowInfo {
    ...
    static let samples: [WindowInfo] = [
        ...
        WindowInfo(windowNumber: 3, ownerPID: 2345, ownerName: "Code", windowName: "TabDog - Visual Studio Code", bounds: CGRect(x: 0, y: 0, width: 1200, height: 800), layer: 0, isOnScreen: true),
